...
### Grab on x86 (or 64-bit) Ubuntu 14.04:
gst-launch-1.0 -v -m udpsrc port=5004 ! "application/x-rtp, media=(string)video, clock-rate=(int)90000, payload=(int)96, encoding-name=(string)H264" ! \
rtph264depay ! h264parse ! queue ! avdec_h264 ! videoconvert ! autovideosink
